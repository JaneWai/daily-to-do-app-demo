...
export const TodoFilters: React.FC<TodoFiltersProps> = ({
  ...
  return (
    <div className="bg-gradient-to-br from-white to-amber-50 rounded-2xl border-2 border-amber-100 p-4 shadow-lg shadow-amber-100/50">
      <div className="flex items-center gap-2 mb-4">
        <Filter size={18} className="text-amber-600" />
        <h3 className="font-medium text-amber-900">Filters & Sort</h3>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div>
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`flex items-center gap-2 px-3 py-2 rounded-lg border transition-all duration-200 shadow-sm ${
                filter === 'all'
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2 border border-amber-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent bg-white/80 text-amber-800 shadow-sm"
          >
